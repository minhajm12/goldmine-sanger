...
<body>
    ...
    <section id="sustainability-main">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 left">
                    <img src="assets/img/sustainability/sus-img-1.png" alt="">
                    <img src="assets/img/sustainability/sus-img-2.png" alt="" class="img-1">
    ...
    <script>
        document.querySelectorAll('.sus-nav-link').forEach((item) => item.classList.add('active'));
    </script>
