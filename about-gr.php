...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="item-card" data-aos="zoom-in-right" data-aos-duration="1000">
                ...
                <div class="col-12 col-lg-6">
                    <div class="item-card" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-delay="500">
    ...
    <section id="about-page-cta">
        <div class="container">
            <div id="cta-section" data-aos="zoom-in-up" data-aos-duration="1000">
                <div class="container">
                    <div class="row">
    ...
    <section id="philosophysection">
        <div class="container">
            ...
            <div class="scnd-row row">
                <div class="col-12 col-lg-6 left" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <img src="assets/img/about-page/philosophy-2.png" alt="" class="phil-img-1">
                    <img src="assets/img/about-page/stroke.png" alt="" class="phil-img-2">
                </div>
